buildscript {
    val this_version: String by extra("0.2.5-beta-0.1-kotlin-1.7.0-RC-space-215")

    val kotlin_version: String by extra("1.7.0-RC-space-215")
...
plugins {
    id("org.jetbrains.kotlin.jvm") version "1.7.0-RC-space-215" apply false
    id("org.jetbrains.kotlin.multiplatform") version "1.7.0-RC-space-215" apply false
}
